            ...
            echo "<table class='table table-bordered table-striped' id='flight-list'>";
                echo "<thead>";
                    echo "<tr>";
                        ...
                        echo "<th class='text-center'>Booked</th>";
                    ...
                    if ($result['flight_type'] === 'Round Trip') {
                        echo "<tr>";
                            ...
                            echo "<td class='text-center'>";
                                echo "<button class='btn btn-outline-primary btn-sm edit_flight' type='button' data-bs-toggle='modal' data-bs-target='#editModal'><i class='fas fa-edit'></i></button>";
                                echo "<button class='btn btn-outline-danger btn-sm delete_flight' type='button' data-bs-toggle='modal' data-bs-target='#deleteModal'><i class='fas fa-trash'></i></button>";
                            echo "</td>";
                        echo "</tr>";
                    } else {
                        echo "<tr>";
